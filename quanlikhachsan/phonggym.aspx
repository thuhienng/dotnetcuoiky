<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phonggym.aspx.cs" Inherits="quanlikhachsan.phonggym" %>
        ...
        <div id="slideanh">
            ...
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <asp:Image ID="img4" runat="server" ImageUrl="~/images/lon_52_943794247.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Img5" runat="server" ImageUrl="~/images/lon_52_1252935764.jpg" Style="width: 100%" />
                </div>
            </div>
            ...
            <div style="margin-top: 20px">
                <asp:Label ID="lblname" Text="PHÒNG GYM" runat="server" Font-Bold="True" Font-Size="20px" Font-Underline="False" ForeColor="#FF9900"></asp:Label><br />
                <hr />
                Vị trí: Tầng 14<br />
                Giờ mở cửa: 6h - 22h<br />
                Được trang bị nhiều thiết bị cần thiết giúp bạn duy trì thói quen tập luyện hàng ngày<br />                
            </div>
        <!--cuối trang-->
