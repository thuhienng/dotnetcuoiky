<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phongconn.aspx.cs" Inherits="quanlikhachsan.phongconn" %>
        ...
        <div id="slideanh">
            ...
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <asp:Image ID="hnghi1" runat="server" ImageUrl="https://ezcloud.vn/wp-content/uploads/2019/05/Connecting-room-700x350.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image1" runat="server" ImageUrl="http://1tour.vn/wp-content/uploads/2015/09/R3R8Connecting-Room.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image2" runat="server" ImageUrl="https://vinapad.com/wp-content/uploads/2018/09/Connect-room-Hotel.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image3" runat="server" ImageUrl="http://lathanhhotel.com/wp-content/uploads/2017/07/VIP-9.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image4" runat="server" ImageUrl="https://buiquyet.com/wp-content/uploads/2019/06/phong-conecting-bamboo-sapa-hotel-2.jpg" Style="width: 100%" />
                </div>
            </div>
         ...
         <div style="margin-top:20px">
                 <asp:Label ID="lblhnghi" Text="PHÒNG CONNECTING " runat="server" Font-Bold="True" font-size="20px" Font-Underline="False" ForeColor="#FF9900"></asp:Label><br />
               <section>
                   <article>
                       ...
                       Phòng được trang bị đầy đủ tiện nghi phù hợp cho kỳ nghĩ dưỡng, du lịch khám phá của quý khách. Phù hợp với nhóm hoặc đại gia đình <br />
                       Phòng rộng khoảng 50m2.<br/>
                       Phòng được bố trí 2 phòng cạnh nhau có cửa thông nhau<br />
- Phòng nằm ở vị trí hướng biển. <br />   
                       Giá phòng: 2.500.000đ/ đêm <br />  
                       </article>
                   <article>                   
