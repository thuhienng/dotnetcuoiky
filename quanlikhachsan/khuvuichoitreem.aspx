<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="khuvuichoitreem.aspx.cs" Inherits="quanlikhachsan.khuvuichoitreem" %>
...
<body>
    <form id="khuvuichoitreem" runat="server">
    <div id="main">
            <div id="menutop">
                <!--phần menutop-->
                <ul>
        ...
        <div id="slideanh">
            ...
            <div class="slideshow-container">                
                <div class="mySlides fade">
                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/lon_79_857090886.jpg" Style="width: 100%" />
                </div>
            </div>
        ...
        <div style="margin-top:20px">
                <asp:Label ID="lblkhuvuichoi" Text="KHU VUI CHƠI TRẺ EM" runat="server" Font-Bold="True" font-size="20px" Font-Underline="False" ForeColor="#FF9900"></asp:Label><br />
                <hr />
                Vị trí: Tầng 2<br />
                Giờ mở cửa: 6h - 21h<br />
                Khu vui chơi trẻ em rộng rãi, thoáng mát với trang trí dễ thương, miễn phí cho tất cả khách lưu trú tại khách sạn.<br />
                Du lịch cùng với gia đình nhỏ, đừng lo, chúng tôi có đến 2 khu vui chơi cho bé phù hợp theo từng độ tuổi, chắc chắn sẽ làm bạn yên tâm.<br/>
